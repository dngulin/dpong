...
// Generated at 2021-03-10T11:36:18.9026550+03:00
...
namespace DPong.Level.State {
    ...
    public unsafe struct BallState {
        ...
        public void WriteDefault() {
            FreezeCooldown = FxNum.FromRaw(0);
            Speed = FxVec2.Zero;
    ...
    public unsafe struct BlockerState2 {
        ...
        public ref BlockerState this[int index] {
            get {
                if (index < 0 || BlockerState.SizeOf * index >= SizeOf) throw new IndexOutOfRangeException();
                return ref At(index);
            }
        }
        ...
        public unsafe ref struct _EnumeratorOfBlockerState2 {
            ...
            public _EnumeratorOfBlockerState2(ref BlockerState2 array) {
                _arrayPtr = (BlockerState2*) Unsafe.AsPointer(ref array);
                _index = -1;
            }
