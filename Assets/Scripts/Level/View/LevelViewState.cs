...
// Generated at 2021-06-19T21:28:18.0212700+03:00
...
namespace DPong.Level.View {
    ...
    public unsafe struct PaddleViewState2 {
        ...
        public ref PaddleViewState this[int index] {
            get {
                if (index < 0 || sizeof(PaddleViewState) * index >= SizeOf) throw new IndexOutOfRangeException();
                return ref At(index);
            }
        }

        private ref PaddleViewState At(int index) {
            fixed (byte* __ptr = _buffer) {
                return ref *((PaddleViewState*)__ptr + index);
            }
        }

        public _EnumeratorOfPaddleViewState2 GetEnumerator() => new _EnumeratorOfPaddleViewState2(ref this);

        public unsafe ref struct _EnumeratorOfPaddleViewState2 {
            private readonly PaddleViewState2* _arrayPtr;
            private int _index;

            public _EnumeratorOfPaddleViewState2(ref PaddleViewState2 array) {
                fixed (PaddleViewState2* arrayPtr = &array) _arrayPtr = arrayPtr;
                _index = -1;
            }

            public bool MoveNext() => ++_index < Length;
            public ref PaddleViewState Current => ref (*_arrayPtr).At(_index);

            public void Reset() => _index = -1;
            public void Dispose() {}
        }

        public static bool operator ==(in PaddleViewState2 l, in PaddleViewState2 r) {
            fixed (byte* __l = l._buffer, __r = r._buffer) {
                return UnsafeUtility.MemCmp(__l, __r, SizeOf) == 0;
            }
        }
        public static bool operator !=(in PaddleViewState2 l, in PaddleViewState2 r) => !(l == r);

        public override bool Equals(object obj) => obj is PaddleViewState2 casted && this == casted;
        public override int GetHashCode() => throw new NotSupportedException();
    }

    public static class PaddleState2ViewExtensions {
        public static PaddleViewState2 ToViewState(this in PaddleState2 value) {
            var result = new PaddleViewState2();
            for (var i = 0; i < PaddleViewState2.Length; i++) {
    ...
    public unsafe struct LevelViewState {
        ...
        [FieldOffset(64)] public PaddleViewState2 Paddles;
