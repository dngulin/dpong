...
namespace DPong.Level.View {
  public class LevelViewGizmoDrawer : MonoBehaviour {
    ...
    private void DrawDynamicState(in LevelViewState state, Color color) {
      ...
      Gizmos.DrawWireCube(state.Paddles.Left.Position, ToVector(_settings.Paddle.Size));
      Gizmos.DrawWireCube(state.Paddles.Right.Position, ToVector(_settings.Paddle.Size));
    }
